					...
					<h2 class="subtitle is-6 has-text-grey">
                     ...
                     <div>
						<form ng-submit="logincontroller.login(logincontroller.credentials)" name="loginBlogForm" class="is-pad-top-40">
							<div ng-switch="login_switch">
								<div ng-switch-when="phase1">
										<!-- Identifiant -->
										<div class="field">
												...
												<div class="field-body">
													<div class="field">
														<p class="control is-fullwidth">
									                          <button ng-click="login_switch_trigger(2)"  type="button" class="button is-outlined is-white">
									                                <span class="has-text-weight-bold">Valider</span>
									                          </button>
														</p>
													</div>
												</div>
								...
								<div ng-switch-when="phase2">
										<span class="label has-text-white">Veuillez inscrire le code OTP</span>
										<div class="field is-horizontal is-pad-top-40">
											  <div class="loginForm control has-icons-right has-icons-left">
												    <input class="input" name='otp' required type="input" placeholder="Code OTP">
												 	<span class="icon is-small is-left">
