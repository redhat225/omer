...
<div class="modal {{initial_audit_report_modal}}" style="font-size: 0.76rem;">
  ...
  <div class="modal-card" style="width:99%;height:99%;overflow: hidden;">
    <header class="eben-grey-b modal-card-head is-none-radius">
      <p class="modal-card-title has-text-black has-text-weight-semibold">Gestion Conformité PCIDSS V3.2.1 - Projet <span class="is-uppercase" ng-bind="current_selected_project.project_name"></span> </p>
	...
	<?= $this->element("Dashboard/initial-audit-report-quick-view") ?>
	...
	<form submit-on="triggerEvent" name="formInitialAuditPcidss"  ng-submit="submit_report_audit_initial()">
		<!-- Proof modal box -->
		<?= $this->element("Dashboard/add_proof"); ?>
		<!-- TAbs Switch Area -->
			    ...
			    <section class="modal-card-body" style="padding: 0px;">
			      <article>
						...
						<table class="table is-fullwidth is-hoverable">
						  ...
						  <tbody>
						  	<tr ng-if="requirement.parent_condition_id == 1" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 2" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 3" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 4" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 5" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 6" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 7" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 8" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 9" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 10" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 11" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
						...
						<table class="table is-fullwidth is-hoverable">
						  <thead class="eben-grey-b">
						    <tr>
						  	...
						  	<tr ng-if="requirement.parent_condition_id == 12" ng-repeat="requirement in current_selected_project.project_meta.pcidssv321" ng-class="requirement.color_cell_stripe" class="">
						  		<!-- Start Manage cell - Condition PCIDSS -->
						  		<th class="narrow_cell" ng-if="requirement.procedure_is_child == 'false'">
						  			<span class="icon has-text-primary" ng-if="requirement.procedure_is_child =='false' && requirement.condition_is_needed_solutions == 'true'">
									  <i class="fa fa-window-restore" ng-click="show_initial_audit_report_quick_view()"></i>
