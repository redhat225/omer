...
<div class="modal {{showInfoProjectModal}}" id="show_workflow_modal">
  ...
  <div class="modal-card" style="width:99%; height: 99%;">
    <header class="modal-card-head is-none-radius">
      <p class="modal-card-title has-text-black has-text-weight-semibold">Informations Projet - <span ng-bind="current_selected_project.project_name" class="is-uppercase"></span> </p>
	...
	<div ng-switch on="workflow_tab">
		<div ng-switch-when="history">
		    <section class="modal-card-body is-pad-top-0">
		    	<div class="columns">
			       ...
			       <div class="field is-horizontal">
		    		...
		    		<div class="column">
							<div class="field is-horizontal">
								...
								<div class="field-body">
									<div class="field">
										<div class="">
												<span class="has-text-weight-semibold is-uppercase">{{current_selected_project.project_name}}</span>
										</div>
									</div>
								</div>
							</div>
					...
					<div ng-switch-when="audit">
						<?= $this->element("Dashboard/audit_box") ?>
					</div>
