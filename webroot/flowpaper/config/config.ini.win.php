...
"path.pdf":"C:\\inetpub\\wwwroot\\flowpaper\\pdf",
"path.swf":"C:\\inetpub\\wwwroot\\flowpaper\\docs",
...
"cmd.conversion.mudraw":"mudraw.exe -r120 -m -o \"{path.swf}{pdffile}_{page}.png\" \"{path.pdf}{pdffile}\" {page}",
