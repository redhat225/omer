    	...
    	<div id="body_proxy" class="section_users section_auth section_app" style="min-height:85%;">
    		<div class="headerx logged_out" id="header">
			   <div id="header_content">
			     <a href="index.php" class="home"><img alt="devaldi Logo" class="logo" id="devaldilogo" src="admin_files/images/flowpaper_logo.png" border=0 /></a>
				 
				  <ul id="nav"> 
				    <li class=""><a href="http://flowpaper.com/" class="home">Home</a></li>
					<li class=""><a href="http://flowpaper.com/docs.htm" class="docs">Docs</a></li>
				  </ul> 
			   </div>
			</div>
			<div id="underlay"></div>
