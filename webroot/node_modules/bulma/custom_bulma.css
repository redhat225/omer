  ...
  .button.is-eben {
    ...
    .button.is-eben:focus, .button.is-eben.is-focused {
      ...
      .button.is-eben:focus:not(:active), .button.is-eben.is-focused:not(:active) {
        box-shadow: 0 0 0 0.125em rgba(214, 26, 39, 0.25); }
    ...
    .button.is-eben.is-outlined {
      ...
      .button.is-eben.is-outlined.is-loading:after {
        border-color: transparent transparent #d61a27 #d61a27 !important; }
...
.file {
  ...
  .file.is-eben:focus .file-cta, .file.is-eben.is-focused .file-cta {
    border-color: transparent;
    box-shadow: 0 0 0.5em rgba(214, 26, 39, 0.25);
    color: #fff; }
...
.hero {
  ...
  .hero.is-eben {
    ...
    .hero.is-eben.is-bold {
      background-image: linear-gradient(141deg, #b20b32 0%, #d61a27 71%, #eb331f 100%); }
      @media screen and (max-width: 768px) {
...
.tooltip {
  ...
  .tooltip.is-tooltip-eben:not(.is-loading)::after {
    border-color: rgba(214, 26, 39, 0.9) transparent transparent transparent; }
  .tooltip.is-tooltip-eben.is-tooltip-right:not(.is-loading)::after {
    border-color: transparent rgba(214, 26, 39, 0.9) transparent transparent; }
  .tooltip.is-tooltip-eben.is-tooltip-bottom:not(.is-loading)::after {
    border-color: transparent transparent rgba(214, 26, 39, 0.9) transparent; }
  .tooltip.is-tooltip-eben.is-tooltip-left:not(.is-loading)::after {
    border-color: transparent transparent transparent rgba(214, 26, 39, 0.9); }
  .tooltip.is-tooltip-eben::before {
    background: rgba(214, 26, 39, 0.9);
    color: #fff; }
...
.steps {
  ...
  .steps .step-item {
    ...
    .steps .step-item.is-eben::before {
      background: linear-gradient(to left, #dbdbdb 50%, #d61a27 50%);
      background-size: 200% 100%;
      background-position: right bottom; }
